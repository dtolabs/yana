            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tag.node.label" default="Node" /></td>
                            
                            <td valign="top" class="value"><g:link controller="node" action="show" id="${tagInstance?.node?.id}">${tagInstance?.node?.encodeAsHTML()}</g:link></td>
