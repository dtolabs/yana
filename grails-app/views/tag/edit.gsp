                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="node"><g:message code="tag.node.label" default="Node" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: tagInstance, field: 'node', 'errors')}">
                                    <g:select name="node.id" from="${yana.node.Node.list()}" optionKey="id" value="${tagInstance?.node?.id}"  />
                                </td>
                            </tr>
